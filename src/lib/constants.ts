...
export const COPY: Record<Lang, {
  ...
  en: {
    ...
    rsvp: {
      ...
      nameLabel: 'Full Name',
      namePlaceholder: 'e.g. Trang Nguyen',
      nameHelper: "Please enter the name of one member of your party. You'll be able to RSVP for your entire group on the next page.",
      submitBtn: 'Send',
  ...
  vi: {
    ...
    rsvp: {
      ...
      nameHelper: 'Vui lòng nhập tên một người trong nhóm của bạn. Bạn có thể xác nhận cho toàn bộ khách đi cùng ở bước tiếp theo.',
